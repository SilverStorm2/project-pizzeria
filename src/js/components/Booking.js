...
class Booking {
    ...
    makeBooked(date, hour, duration, table) {
        ...
        utils.createPropIfUndefined(thisBooking.booked, date, {});
        ...
        for(let 
            ...
            hourBlock += 0.5)
            {
            utils.createPropIfUndefined(thisBooking.booked[date], hourBlock, []);
    ...
    updateDOM() {
        ...
        if (prevSelectedTable) {
            const tableToSelect = thisBooking.dom.tablesWrapper.querySelector(
                `[data-table="${prevSelectedTable}" ]`);
    ...
    sendBooking() {
        ...
        .then(response => {
            ...
            if (thisBooking.datePicker.dom.input._flatpickr) {
                thisBooking.datePicker.dom.input._flatpickr.setDate(thisBooking.datePicker.minDate, true);
            } else {
                thisBooking.datePicker.dom.input.value = utils.dateToStr(thisBooking.datePicker.minDate);
                thisBooking.datePicker.dom.input.dispatchEvent(new Event('change'));
            }
